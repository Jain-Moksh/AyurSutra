      ...
      <div className="flex-1 p-3 sm:p-4 lg:p-6 overflow-y-auto">
        <div className="bg-white rounded-xl shadow-lg p-4 lg:p-6 border border-gray-100">
          <div className="flex items-center space-x-3 mb-4 lg:mb-6">
            ...
            <div>
              <h2 className="text-lg lg:text-xl font-bold text-gray-800">My Prescriptions</h2>
              <p className="text-sm text-gray-600">View and manage your medications</p>
            </div>
          </div>
          
          <div className="text-center py-12">
            <div className="text-6xl mb-4">💊</div>
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Prescriptions Coming Soon</h3>
